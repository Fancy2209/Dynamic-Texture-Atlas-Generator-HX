	...
	class DynamicAtlas
	{
		...
		*/
		static private function isEmbedded(fontFamily:String):Bool 
		{
		   ...
		   while (i > -1 && embeddedFonts[i].fontName != fontFamily) { i--; }
		 ...
		 *@return TextureItem
		 */
		static private function drawItem(clip:DisplayObject, name:String = "", baseName:String = "", clipColorTransform:ColorTransform = null, frameBounds:Rectangle=null):TextureItem
		{
			...
			var item:TextureItem = new TextureItem(_bData, name, label, Std.int(realBounds.x), Std.int(realBounds.y), Std.int(realBounds.width), Std.int(realBounds.height));
         ...
         */
        static public function fromClassVector(assets:Array<Dynamic>, scaleFactor:Float = 1, margin:UInt=0, preserveColor:Bool = true, checkBounds:Bool=false):TextureAtlas
        {
		 ...
		 *@return  TextureAtlas - The dynamically generated Texture Atlas.
		 */
		static public function fromMovieClipContainer(swf:Sprite, scaleFactor:Float = 1, margin:UInt=0, preserveColor:Bool = true, checkBounds:Bool=false):TextureAtlas
		{
		 ...
		 */
		static public function bitmapFontFromString(chars:String, fontFamily:String, fontSize:Float = 12, bold:Bool = false, italic:Bool = false, charMarginX:Int=0, fontCustomID:String=""):Void {
		 ...
		 */
		 static public function bitmapFontFromTextField(tf:openfl.text.TextField, charMarginX:Int=0, fontCustomID:String=""):Void {
			...
			if (_canvas == null) _canvas = new Sprite();
